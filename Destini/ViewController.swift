...
/*if topButton was pressed {
 change the storyview to story 3
 ...
 change the bottombutton title to answer 3b */
       ...
       //importante ser else if para nao confundir com a tag 0
            ...
            //nao havera mais botoes para serem alterados
    ...
    @IBAction func apertarRestart(_ sender: UIButton) {
        restart()
    }
func restart() {
            storyIndex = 1
            ...
            //set title para mudar o nome do botao
